...
# ``fai_fetch`` returns a ``(void *)`` as *we* need to free the memory and
# ctypes casts a ctypes.c_char_p into ``bytes`` and we do not get to the
# original pointer any more, cmp. http://stackoverflow.com/a/13909517/84349
